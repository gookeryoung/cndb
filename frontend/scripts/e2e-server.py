...
def main() -> int:
    ...
    seed = subprocess.run(  # nosec B603,B607 - nosemgrep:python.lang.security.audit.subprocess-without-shell-equals-true - 命令为固定常量，uv 来自 PATH
        ["uv", "run", "cndb", "seed"],
        check=False,
        cwd=root,
    )
    ...
    return subprocess.call(  # nosec B603,B607 - nosemgrep:python.lang.security.audit.subprocess-without-shell-equals-true - 命令为固定常量，uv 来自 PATH

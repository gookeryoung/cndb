...
- [ ] P0 框架基座：Alembic + JWT/ApiToken 认证 + route_prefix 扩展 + 前端登录
- [ ] P1 工作区与成员（四级角色）
- [ ] P2 表/字段/动态 DDL/行数据/查询编译 + Grid 前端
- [ ] P3 五种视图规则与端点 + 视图前端
- [ ] P4 表级权限/行级/字段级 + 公开表单/共享视图
- [ ] P5 导入导出/异步导入/评论/回收站/审计/表复制移动/关系图
- [ ] P6 报表模板与三格式渲染
- [ ] P7 seed/性能基准/Docker 部署/README 收尾
